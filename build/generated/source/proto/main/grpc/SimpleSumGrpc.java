...
public final class SimpleSumGrpc {
  ...
  public static final String SERVICE_NAME = "SimpleSum";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<Sum.SimpleSumRequest,
      Sum.SimpleSumResponse> getStreamSimpleSumMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "streamSimpleSum",
      requestType = Sum.SimpleSumRequest.class,
      responseType = Sum.SimpleSumResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Sum.SimpleSumRequest,
      Sum.SimpleSumResponse> getStreamSimpleSumMethod() {
    io.grpc.MethodDescriptor<Sum.SimpleSumRequest, Sum.SimpleSumResponse> getStreamSimpleSumMethod;
      ...
      synchronized (SimpleSumGrpc.class) {
        if ((getStreamSimpleSumMethod = SimpleSumGrpc.getStreamSimpleSumMethod) == null) {
          SimpleSumGrpc.getStreamSimpleSumMethod = getStreamSimpleSumMethod =
              io.grpc.MethodDescriptor.<Sum.SimpleSumRequest, Sum.SimpleSumResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "streamSimpleSum"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Sum.SimpleSumRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Sum.SimpleSumResponse.getDefaultInstance()))
  ...
  public static abstract class SimpleSumImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void streamSimpleSum(Sum.SimpleSumRequest request,
        io.grpc.stub.StreamObserver<Sum.SimpleSumResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                Sum.SimpleSumRequest,
                Sum.SimpleSumResponse>(
  ...
  public static final class SimpleSumBlockingStub extends io.grpc.stub.AbstractStub<SimpleSumBlockingStub> {
    ...
    /**
     */
    public Sum.SimpleSumResponse streamSimpleSum(Sum.SimpleSumRequest request) {
  ...
  public static final class SimpleSumFutureStub extends io.grpc.stub.AbstractStub<SimpleSumFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Sum.SimpleSumResponse> streamSimpleSum(
        Sum.SimpleSumRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_STREAM_SIMPLE_SUM:
          serviceImpl.streamSimpleSum((Sum.SimpleSumRequest) request,
              (io.grpc.stub.StreamObserver<Sum.SimpleSumResponse>) responseObserver);
          break;
        default:
